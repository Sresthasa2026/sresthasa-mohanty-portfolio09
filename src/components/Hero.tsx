  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center tech-bg overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 border-2 border-secondary/20 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-32 left-20 w-12 h-12 bg-primary/10 rotate-12 animate-float" style={{ animationDelay: '4s' }}></div>
        <div className="absolute bottom-20 right-32 w-24 h-24 border border-accent/20 rotate-45 animate-float" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4">
              <Button 
                size="lg" 
                className="btn-glow bg-gradient-to-r from-primary to-primary-glow hover:shadow-lg"
              >
                View My Work
              </Button>
          ...
          <div className="relative animate-slide-in-right">
            <div className="relative w-96 h-96 mx-auto lg:w-[500px] lg:h-[500px]">
              ...
              <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-primary/30 hover:border-primary/50 transition-all duration-500 float">
                <img 
                  src={heroProfile} 
                  alt="Sresthasa Mohanty - AI/ML Engineer" 
